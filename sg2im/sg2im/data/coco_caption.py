...
class CocoCaptionDataSet(Dataset):
    def _init_(self, image_dir, captions_json,instances_json, stuff_json=None,
        ...
        if captions_data:
            ...
            for caption_data in captions_data['annotations']:
                ...
                self.image_id_to_captions[image_id].append(caption_data)#More than one caption data each image
            #new_image_ids = []
        ...
        self.sentences = [caption_sentences for caption_sentences in self.image_id_to_captions]
    ...
    def __getitem__(self, index):
        ...
        captions = []
        for caption_data in self.image_id_to_captions[image_id]:
