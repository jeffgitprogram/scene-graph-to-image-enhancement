...
def coco_caption_collate_fn(batch):
  ...
  """
  all_imgs, all_objs, all_boxes, all_masks, all_triples,all_hiddens = [], [], [], [], [], []
  all_obj_to_img, all_triple_to_img = [], []
  obj_offset = 0
  for i, (img, objs, boxes, masks, triples, hiddens) in enumerate(batch):
  ...
  out = (all_imgs, all_objs, all_boxes, all_masks, all_triples,
         all_obj_to_img, all_triple_to_img, all_hiddens)
  return out
